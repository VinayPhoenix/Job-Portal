...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="add_job.jsp"> <i class="fa-solid fa-circle-plus"></i>Post Jobs</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="viewjobs.jsp"><i class="fa-solid fa-eye"></i>View Jobs</a>
      </li>
